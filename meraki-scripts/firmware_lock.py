...
This script requires a configuration file to run. By default, it will try to open file "config_firmware_lock.yaml,
located in the same folder as the script itself. Copy "config.yaml.example" to "config_firmware_lock.yaml", and edit this 
...
DEFAULT_CONFIG_FILE_NAME    = "config_firmware_lock.yaml"
